...
# Create another server at node 1 on port 109
echoServer = ns.applications.UdpEchoServerHelper(109)
serverApps = echoServer.Install(nodes.Get(1))
...
#Create another client at node 0 port 109
echoClient2 = ns.applications.UdpEchoClientHelper(interfaces.GetAddress(1), 109)
clientApps2 = echoClient2.Install(nodes.Get(0))

# Create another server at node 1 on port 109
echoServer2 = ns.applications.UdpEchoServerHelper(109)
